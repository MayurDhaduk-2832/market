...
class LocaleKeys {
  ...
  // static const documentPath = "/data/user/0/com.joso.android/app_flutter/";

  // static String appType = "_";
  // static String appType = "_staging_";
  // static String appType = "_dev_";
  ...
  static const createBAccount = "Create Business Account";
